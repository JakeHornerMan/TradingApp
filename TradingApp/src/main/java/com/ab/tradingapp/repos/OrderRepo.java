...
public interface OrderRepo extends JpaRepository<Order,Integer> {
	...
	@Modifying
	@Transactional
	@Query(value = "INSERT INTO Orders (user_id, stock_id, exchange_code, type, transaction_amount,transaction_cost,order_date, stock_name) VALUES (:user_id, :stock_id, :exchange_code, :type, :transaction_amount, :transaction_cost, :order_date, :stock_name)", nativeQuery = true)
	public Integer insertItemsIntoOrders(@Param("user_id") int user_id, @Param("stock_id") int stock_id, @Param("exchange_code") String exchange_code,  
			...
			@Param("order_date") LocalDateTime order_date, @Param("stock_name") String stock_name);
